			...
			<tbody>
				<tr>
					<td width="5%" align="left" class="grid-tbl-title">#</td>
                                        <td width="35%" align="left" class="grid-tbl-title">Specific Test Name</td>
                                        <td width="20%" align="left" class="grid-tbl-title">Generic Test Name</td>

					<td width="20%" align="center" class="grid-tbl-title">Status</td>
				...
				<tr class="grid-tbl-td1">
					...
					<td valign="top" align="left"><?php 
						...
						echo $test['TestCategory']['category_name'];
					...
					$status_id = $test['Test']['status_id'];
					
					echo $this->Form->input('status_id', array('div'=>false, 'label'=>false, 'class'=>'inputfield', 'style'=>'width:80px;', 'type'=>'select', 'id' =>'status_id_'.$i,'options'=>$statuses, 'selected'=>$status_id, 'empty'=>false, 'onchange' => 'perform_operation_test_status("ChangeStatus","'.$test['Test']['id'].'","'.$status_id.'", "'.$i.'");'));
						...
						<table width="100%" border="0"  cellspacing="1" cellpadding="1">
							<tr>
								<td width="52%" align="center">
										...
										<a href="<?php echo $this->webroot;?>manage_test/add_edit_test/<?php echo $test['Test']['id'];?>" >
						...
						<table width="100%" border="0"  cellspacing="1" cellpadding="1">
							<tr>
								<td width="52%" align="center">
									...
									<a href="javascript:void(0);" onclick="javascript:return perform_delete(<?php echo $test['Test']['id'];?>)" >
