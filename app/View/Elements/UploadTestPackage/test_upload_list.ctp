...
?>			
								...
								<td width="10%" align="center" class="grid-tbl-title">Clinic Name</td>
                                                                ...
                                                                <td width="35%" align="center" class="grid-tbl-title">Errors</td>
                        	...
                        	<td align="left" nowrap="nowrap" >
                        		<?php echo $testDetails['PackageName'];?>
                        	</td>
                                <td  align="left" nowrap="nowrap" >
							...
							?>
							<tr>
								<td colspan="6" align="center" style="color:#FF0000; font-size:12px; font-weight:bold">No results found</td>
							</tr>
							<?php
								}
							?>
