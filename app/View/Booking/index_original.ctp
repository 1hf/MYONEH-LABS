              ...
              <?php 
                ...
                <div class="form-group textarea_aria2" id="home_collection_div">
				  ...
				  <div class="col-md-12" style="padding-left: 0px;">
					<div class="col-md-3" style="padding-left: 0px;"><label for="home_collection_date">Date<span class="red-mark-star">*</span></label>
                  ...
                  <br /><span class="red-mark" id="error_home_collection_date" style="display:none;color:red" ></span></div>
					<div class="col-md-3" style="padding-left: 0px;"><label for="home_collection_time">Time <span class="red-mark-star">*</span></label>
          ...
          <div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
            <div class="panel-body">
			  ...
			  <div class="title_row">HOME COLLECTION DETAILS</div>
				<div class="item_wrapp">
					<div class="item"><span class="item_details">Address</span> <span style="float:left;" id="home_address_span"></span> </div>
