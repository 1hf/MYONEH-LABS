...
<?php
	...
	//echo $this->Html->css('../fancybox/jquery.fancybox.css?v=2.1.5');		
...
<div class="container header_wrapp">
  <div class="row clearfix header">
    <div class="col-md-4 column">
        ...
        <?php //echo $this->Html->link($this->Html->image('logo.png', array('alt' => 'logo', 'border' => '0','width'=>'30%')),Configure::read('medtest_root_path'),array('escape' => false));
		echo $this->Html->link($this->Html->image('OneHealthlogo-01.jpg', array('alt' => 'logo', 'border' => '0','width'=>'30%')),Configure::read('medtest_root_path'),array('escape' => false));
         ?>
    </div>
