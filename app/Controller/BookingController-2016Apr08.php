...
//$home_collection_flag = 1;
                if($home_collection_flag==1){
					...
					$home_collection_address2 = $this->request->data['home_collection_address2'];
					$home_collection_state = $this->request->data['home_collection_state'];
					$home_collection_city = $this->request->data['home_collection_city'];
					$home_collection_pincode = $this->request->data['home_collection_pincode'];
					$home_collection_date = $this->request->data['home_collection_date'];
					$home_collection_time = $this->request->data['home_collection_time'];
//$home_collection_address = "Bangalore";

                }
                //echo $home_collection_address."  ".$home_collection_date."  ".$home_collection_time; exit;
			  ...
			  if($test_type=="test_package"){
				...
				$booking_data['home_collection_address2'] = $home_collection_address2;
				$booking_data['home_collection_state'] = $home_collection_state;
				$booking_data['home_collection_city'] = $home_collection_city;
				$booking_data['home_collection_pincode'] = $home_collection_pincode;
				$booking_data['home_collection_date'] = $home_collection_date;
				$booking_data['home_collection_time'] = $home_collection_time;
...
/*
//PAYMENT TYPE PAYTM START
if($payment_type=="paytm") {   
//$_SESSION['orderId'] = $booking_id;            
$checkSum = "";
$paramList = array();
...
$paramList["CALLBACK_URL"] = "http://labs.myoneh.com/booking/confirmbooking";
...
//PAYMENT TYPE PAYTM END 
else{
	echo "hai".$payment_type;
	exit;
}
